...
export const BBMHeroData = {
    heading: "Welcome to BBM Coin (Boost Bullion Market Coin)",
    kind: "Where Blockchain Meets Bullion. Global. Secure. Scalable.",
    description:
        "BBM Coin is more than just a cryptocurrency—it's a gateway to the future of global commodity trading, powered by the Binance Smart Chain (BSC). Designed with trust, speed, and real-world utility in mind, BBM Coin opens new doors for investors, traders, and everyday users worldwide",
};
...
const BBMHero = ({ data = BBMHeroData, backgroundImage }) => {
